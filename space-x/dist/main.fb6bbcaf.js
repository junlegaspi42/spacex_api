...
function showLuanchInfo(SpaceXData) {
  ...
  div.innerHTML = "\n   \n\n        <div class=\"container\">\n        <div class=\"col-6 col-sm-4\">Mission Name: ".concat(data.mission_name, "</div>\n        <div class=\"col-6 col-sm-4\">Launch Year: ").concat(data.launch_year, "</div>\n        <div class=\"col-6 col-sm-4\">Rocket Name : ").concat(data.rocket.rocket_name, "</div>\n        <div class=\"col-6 col-sm-4\">Rocket Type : ").concat(data.rocket.rocket_type, "</div>\n        <div class=\"w-100 d-none d-md-block\"></div>\n        <div class=\"col-6 col-sm-4\">Launch Site : ").concat(data.launch_site.site_name_long, "</div>\n        </div>\n        ");
